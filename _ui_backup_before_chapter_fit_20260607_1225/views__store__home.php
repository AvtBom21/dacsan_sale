...
>
    <header class="glass-header">
        <a class="logo" href="#hero" onclick="scrollToSection('hero')">Đặc Sản Nhà Dân</a>
        ...
        <nav class="nav-links" id="nav-links" aria-label="Điều hướng chính">
            <button type="button" onclick="scrollToSection('story')">Câu chuyện</button>
            <button type="button" onclick="scrollToSection('gialai')">Gia Lai</button>
            <button type="button" onclick="scrollToSection('binhdinh')">Bình Định</button>
    ...
    <main>
        <section class="hero-section has-video" id="hero" style="--section-bg: url('<?= htmlspecialchars($sectionMediaBase, ENT_QUOTES, 'UTF-8') ?>/highland-origin.jpeg')">
            ...
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <button class="btn-primary" type="button" onclick="scrollToSection('gialai')">Khám phá Gia Lai</button>
                    <button class="btn-secondary" type="button" onclick="scrollToSection('binhdinh')">Khám phá Bình Định</button>
                </div>
        ...
        <section class="story-section has-video" id="story" style="--section-bg: url('<?= htmlspecialchars($sectionMediaBase, ENT_QUOTES, 'UTF-8') ?>/binh-dinh-boats.jpeg')">
            <div class="section-media" aria-hidden="true">
        ...
        <section class="region-section region-gialai" id="gialai" style="--section-bg: url('<?= htmlspecialchars($sectionMediaBase, ENT_QUOTES, 'UTF-8') ?>/gia-lai-cows.jpeg')">
            <div class="section-overlay"></div>
        ...
        <section class="region-section region-binhdinh" id="binhdinh" style="--section-bg: url('<?= htmlspecialchars($sectionMediaBase, ENT_QUOTES, 'UTF-8') ?>/binh-dinh-underwater.jpeg')">
            <div class="section-overlay sea"></div>
            <div class="region-copy">
            ...
            <aside class="final-cta">
                ...
                <button class="btn-primary" type="button" onclick="scrollToSection('gialai')">Chọn đặc sản hôm nay</button>
            </aside>
