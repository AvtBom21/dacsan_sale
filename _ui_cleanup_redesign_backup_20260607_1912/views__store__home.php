...
>
    ...
    <nav class="chapter-rail" aria-label="Điều hướng chapter">
        <button type="button" onclick="scrollToSection('ch1')"><strong>CH1</strong><span>Hero</span></button>
        <button type="button" onclick="scrollToSection('ch2')"><strong>CH2</strong><span>Câu chuyện</span></button>
        <button type="button" onclick="scrollToSection('ch3')"><strong>CH3</strong><span>Gia Lai</span></button>
        <button type="button" onclick="scrollToSection('ch4')"><strong>CH4</strong><span>Bình Định</span></button>
    </nav>
