...
--   - Copy ảnh sản phẩm vào đúng tên file trong bảng product_images.image_path.
...
INSERT INTO product_images (product_id, image_path, source_url, image_alt, is_base, sort_order) VALUES
  ('pro_001', 'products_image/cha-lua-cay_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/chalua.jpg', 'Chả lụa cây', 1, 1),
  ('pro_001', 'products_image/cha-lua-cay_detail_01.jpg', '', 'Chả lụa cây - ảnh chi tiết', 0, 2),
  ('pro_002', 'products_image/nem-chua-cay_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/nemchua.jpg', 'Nem chua cây', 1, 1),
  ('pro_002', 'products_image/nem-chua-cay_detail_01.jpg', '', 'Nem chua cây - ảnh chi tiết', 0, 2),
  ('pro_003', 'products_image/cha-lua-goi_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/chalua_goi.png', 'Chả lụa gói', 1, 1),
  ('pro_003', 'products_image/cha-lua-goi_detail_01.jpg', '', 'Chả lụa gói - ảnh chi tiết', 0, 2),
  ('pro_004', 'products_image/nem-chua-goi_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/nemchua_goi.jpg', 'Nem chua gói', 1, 1),
  ('pro_004', 'products_image/nem-chua-goi_detail_01.jpg', '', 'Nem chua gói - ảnh chi tiết', 0, 2),
  ('pro_005', 'products_image/cha-ram_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/charamtomdat.jpg', 'Chả ram', 1, 1),
  ('pro_005', 'products_image/cha-ram_detail_01.jpg', '', 'Chả ram - ảnh chi tiết', 0, 2),
  ('pro_013', 'products_image/ca-chi-vang_main.jpg', '', 'Cá chỉ vàng', 1, 1),
  ('pro_013', 'products_image/ca-chi-vang_detail_01.jpg', '', 'Cá chỉ vàng - ảnh chi tiết', 0, 2),
  ('pro_006', 'products_image/bo-mot-nang_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/main/BoMotNang.png', 'Bò một nắng', 1, 1),
  ('pro_006', 'products_image/bo-mot-nang_detail_01.jpg', '', 'Bò một nắng - ảnh chi tiết', 0, 2),
  ('pro_007', 'products_image/heo-mot-nang_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/c13ba4ab0010f674207093e02dc97f8b5b2e480c/heo_mot_nang.jpg', 'Heo một nắng', 1, 1),
  ('pro_007', 'products_image/heo-mot-nang_detail_01.jpg', '', 'Heo một nắng - ảnh chi tiết', 0, 2),
  ('pro_008', 'products_image/gau-bo-mot-nang_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/c13ba4ab0010f674207093e02dc97f8b5b2e480c/gau_bo_mot_nang.png', 'Gàu bò một nắng', 1, 1),
  ('pro_008', 'products_image/gau-bo-mot-nang_detail_01.jpg', '', 'Gàu bò một nắng - ảnh chi tiết', 0, 2),
  ('pro_009', 'products_image/kho-bo-soi_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/KhoBoSoi.png', 'Khô bò sợi', 1, 1),
  ('pro_009', 'products_image/kho-bo-soi_detail_01.jpg', '', 'Khô bò sợi - ảnh chi tiết', 0, 2),
  ('pro_010', 'products_image/kho-bo-mieng_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/KhoBoMieng.png', 'Khô bò miếng', 1, 1),
  ('pro_010', 'products_image/kho-bo-mieng_detail_01.jpg', '', 'Khô bò miếng - ảnh chi tiết', 0, 2),
  ('pro_011', 'products_image/yen-tinh-che-khong-kem-hop_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/yen.jpg', 'Yến tinh chế (không kèm hộp)', 1, 1),
  ('pro_011', 'products_image/yen-tinh-che-khong-kem-hop_detail_01.jpg', '', 'Yến tinh chế (không kèm hộp) - ảnh chi tiết', 0, 2),
  ('pro_012', 'products_image/yen-tinh-che-kem-hop_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/yenvshop.png', 'Yến tinh chế (kèm hộp)', 1, 1),
  ('pro_012', 'products_image/yen-tinh-che-kem-hop_detail_01.jpg', '', 'Yến tinh chế (kèm hộp) - ảnh chi tiết', 0, 2),
  ('Pro_711_0', 'products_image/pin-cai-net-viet_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/Product_Images/gen-n-bin2.jpg', 'Pin cài Nét Việt', 1, 1),
  ('Pro_711_0', 'products_image/pin-cai-net-viet_detail_01.jpg', '', 'Pin cài Nét Việt - ảnh chi tiết', 0, 2),
  ('Pro_711_1', 'products_image/pin-cai-chao-buoi-sang_main.jpg', 'https://raw.githubusercontent.com/AvtBom21/Certificate/a8e82260a5781ffc31c83de9bd047429472d386d/gen-n-bin1.jpg', 'Pin cài Chào Buổi Sáng', 1, 1),
  ('Pro_711_1', 'products_image/pin-cai-chao-buoi-sang_detail_01.jpg', '', 'Pin cài Chào Buổi Sáng - ảnh chi tiết', 0, 2);
